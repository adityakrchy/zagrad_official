                    ...
                    <div className="flex flex-wrap ">
                        <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                            <div className="relative">
                                ...
                                <div
                                    className="absolute z-10 hidden w-full h-full bg-indigo-500 rounded-bl-[80px] rounded -bottom-6 right-6 lg:block">
                                </div>
                                {/* <div
                        ...
                        <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
                            <div className="relative">
                                ...
                                <h1 className="pl-2 text-3xl font-bold border-l-8 border-indigo-500 md:text-5xl ">
                                    Welcome to our site
                                </h1>
                            </div>
                            ...
                            <a href="#"
                                className="px-4 py-3 text-gray-50 transition-all transform bg-indigo-500 rounded-[80px] hover:bg-indigo-600 dark:hover:text-gray-100 dark:text-gray-100 ">
                                Learn more
                            </a>
                        </div>
                    </div>
