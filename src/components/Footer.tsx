  ...
  return (
    <footer className="bg-white">
      <div className="mx-auto px-4 pb-6 pt-16 sm:px-6 lg:px-8">
            ...
            <div className="mx-auto mt-8 max-w-md sm:ms-0">
              ...
              <form className="mt-4">
                <div className="flex flex-col gap-4 sm:flex-row lg:flex-col lg:items-start">
                  ...
                  <input
                    className="w-full rounded-full border-2 border-gray-200 px-6 py-3 shadow-sm"
                    type="email"
        ...
        <div className="mt-16 border-t border-gray-100 pt-6 lg:flex lg:items-center lg:justify-between">
          ...
          <ul className="mt-4 flex justify-center gap-6 sm:mt-0 sm:justify-start">
            ...
            <li>
              <Link
                href="https://www.threads.net/@zagrad_official"
                rel="noreferrer"
                target="_blank"
                className="text-gray-900"
              >
                ...
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <image href="/threads-seeklogo.svg" width="24" height="24" />
                </svg>
