    ...
    return (
        ...
        >
            ...
            <div className="mt-4 px-2 pb-5">
                ...
                <Link href="#" className="flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-[10px] font-medium text-white hover:bg-gray-700 focus:outline-none sm:text-sm focus:ring-4 focus:ring-blue-300">
