                    ...
                    <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-4 space-y-2 md:space-y-4 sm:p-6">
                            ...
                            <div className='sm:flex gird sm:grid-cols-2'>
                                <button onClick={() => signIn("google")} className="py-1 px-1 border mb-2 border-indigo-500 rounded-lg mx-1 w-44 flex justify-center items-center hover:border-b-2">
                                ...
                                <Link href="/login/loginPhone" className="py-1 px-1 border mb-2 border-indigo-500 rounded-lg w-56 flex justify-center items-center hover:border-b-2">
                            ...
                            <form className="space-y-4 md:space-y-6" action="#">
                                ...
                                <button type="submit" className="w-full text-white bg-indigo-500 hover:bg-indigo-600 hover:shadow-form focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign in</button>
