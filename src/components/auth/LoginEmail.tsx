                    ...
                    <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-4 space-y-2 md:space-y-4 sm:p-6">
                            ...
                            <div className='flex gird grid-cols-2'>
                                <Link href="#" className="mx-1 w-44 flex justify-center items-center hover:border-b-2">
                                    <svg className="h-5 mr-1" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Link href="/loginPhone" className="mx-1 w-56 flex justify-center items-center hover:border-b-2">
