                    ...
                    <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <div className='flex gird grid-cols-2'>
                                <a href="#" className="mx-1 w-40 flex justify-center items-center border border-black">
                                ...
                                <a href="/loginPhone" className="mx-1 w-52 flex justify-center items-center border border-black">
