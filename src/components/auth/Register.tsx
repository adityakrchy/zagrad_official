                    ...
                    <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-4 space-y-2 md:space-y-4 sm:p-6">
                            ...
                            <div className='flex gird grid-cols-2'>
                                <a href="#" className="mx-1 w-44 flex justify-center items-center">
                                ...
                                <a href="/loginPhone" className="mx-1 w-56 flex justify-center items-center">
                            ...
                            <form className="space-y-4 md:space-y-6" action="#">
                                ...
                                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                    Already have an account? <a href="/loginEmail" className="font-medium text-[#6A64F1] hover:underline dark:text-primary-500">Login here</a>
                                </p>
                            </form>
                        </div>
                    </div>
