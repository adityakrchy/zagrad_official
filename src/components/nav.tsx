    ...
    return (
        <nav className="bg-white w-full top-0 z-50 sticky">
            ...
            <div className="items-center px-4  mx-auto md:px-8 flex ">
                ...
                <div className="hidden md:flex items-center justify-between py-3 lg:py-4 ">
                    <Link href="/">
                        <Image
                            src="/zagard_svg.svg"
                            width={150}
                ...
                <div className="block md:hidden items-center justify-between py-3 lg:py-4 ">
                    <Link href="/">
                        <Image
                            src="/zagrad_logo.png"
                            width={45}
                ...
                <div className='md:hidden flex pr-5 justify-between '>
                    <ul className="flex">
